...
QT_MOC_LITERAL(1, 12, 20), // "returnSelectFunction"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 16) // "functionSelected"

    },
    "popupWidget\0returnSelectFunction\0\0"
    "functionSelected"
};
...
void popupWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->returnSelectFunction((*reinterpret_cast< QStringList(*)>(_a[1]))); break;
        case 1: _t->functionSelected(); break;
        default: ;
        }
        ...
        {
            typedef void (popupWidget::*_t)(QStringList );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&popupWidget::returnSelectFunction)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject popupWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_popupWidget.data,
...
// SIGNAL 0
void popupWidget::returnSelectFunction(QStringList _t1)
{
