...
QSwitchButton::QSwitchButton(QWidget *parent) : QAbstractButton(parent),
_height(16),
_opacity(0.000),
_switch(false),
_margin(3),
...
void QSwitchButton::setOffset(int o)
{
	_x = o;
	update();
}

bool QSwitchButton::switchState()
{
	return _switch;
}
...
void QSwitchButton::enterEvent(QEvent *e) {
...
void QSwitchButton::setBrush(const QBrush & brsh)
{
	_brush = brsh;
}
